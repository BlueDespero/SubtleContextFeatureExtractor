...
if __name__ == '__main__':
    ...
    for name in ['the count of monte cristo','madame bovary','les miserables']:
        ...
        if init:
            ...
            feature_extractor.load_state_dict(torch.load(r'..\trained_models\FE_bert_1.model'))
        ...
        print('Training...')
        training(model, data_loader, log_every=3,learning_rate=0.01,device=device,max_num_epochs=4)
